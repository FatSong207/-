...
namespace Yuebon.Chaochi.IRepositories
{
    ...
    /// 
    /// </summary>
    public interface IExternalformRepository : IRepository<Externalform, string>
    {
        /// <summary>
        /// 根據用戶帳號查詢用戶信息
        /// </summary>
       ...
       Task<User> GetUserByEmail(string email);
        ...
        bool Insert(Externalform entity, Security.Models.UserLogOn userLogOnEntity, IDbTransaction trans = null);
        /// <summary>
        /// 註冊用戶
        /// </summary>
        /// <param name="entity"></param>
        ...
        /// <param name="userLogOnEntity"></param>
        /// <param name="trans"></param>
        bool Insert(Externalform entity, Security.Models.UserLogOn userLogOnEntity, Security.Models.UserOpenIds userOpenIds, IDbTransaction trans = null);
        /// <summary>
        /// 根據第三方OpenId查詢用戶信息
        /// </summary>
