...
namespace Yuebon.Chaochi.IRepositories
{
    ...
    /// 
    /// </summary>
    public interface ICustomerLSBuildingRepository : IRepository<CustomerLSBuilding, string>
    {
        /// <summary>
        /// 根據用戶帳號查詢用戶信息
        /// </summary>
        ...
        /// <returns></returns>
        Task<CustomerLSBuilding> GetByLSID(string LSID);
       ...
       Task<User> GetUserByEmail(string email);
        ...
        bool Insert(CustomerLN entity, Security.Models.UserLogOn userLogOnEntity, IDbTransaction trans = null);
        /// <summary>
        /// 註冊用戶
        /// </summary>
        /// <param name="entity"></param>
        /// <param name="userLogOnEntity"></param>
        /// <param name="trans"></param>
        Task<bool> InsertAsync(CustomerLN entity, Security.Models.UserLogOn userLogOnEntity, IDbTransaction trans = null);
        /// <summary>
        /// 註冊用戶,第三方平臺
        /// </summary>
        /// <param name="entity"></param>
        /// <param name="userLogOnEntity"></param>
        /// <param name="trans"></param>
        bool Insert(CustomerLN entity, Security.Models.UserLogOn userLogOnEntity, Security.Models.UserOpenIds userOpenIds, IDbTransaction trans = null);
        /// <summary>
        /// 根據第三方OpenId查詢用戶信息
        /// </summary>
        ...
        public Task<IEnumerable<CustomerLSBuilding>> FindByLSID(string LSID);
    }
}