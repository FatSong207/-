...
namespace Yuebon.Chaochi.IRepositories
{
    ...
    public interface IBuildingRepository : IRepository<Building, string>
    {
        ...
        /// <returns></returns>
        Task<Building> GetByBAdd(string BAdd);
        ...
        /// <returns></returns>
        Task<Building> GetByBID(string BID);
       ...
       Task<User> GetUserByEmail(string email);
        ...
        bool Insert(Building entity, Security.Models.UserLogOn userLogOnEntity, IDbTransaction trans = null);
        /// <summary>
        /// 註冊用戶
        /// </summary>
        /// <param name="entity"></param>
        ...
        /// <param name="userLogOnEntity"></param>
        /// <param name="trans"></param>
        bool Insert(Building entity, Security.Models.UserLogOn userLogOnEntity, Security.Models.UserOpenIds userOpenIds, IDbTransaction trans = null);
        /// <summary>
        /// 根據第三方OpenId查詢用戶信息
        /// </summary>
