...
namespace Yuebon.Chaochi.IRepositories
{
    ...
    /// 
    /// </summary>
    public interface IBuildingBelongingRepository : IRepository<BuildingBelonging, string>
    {
        /// <summary>
        /// 根據用戶帳號查詢用戶信息
        /// </summary>
       ...
       Task<User> GetUserByEmail(string email);
        ...
        bool Insert(BuildingBelonging entity, Security.Models.UserLogOn userLogOnEntity, IDbTransaction trans = null);
        /// <summary>
        /// 註冊用戶
        /// </summary>
        /// <param name="entity"></param>
        /// <param name="userLogOnEntity"></param>
        /// <param name="trans"></param>
        Task<bool> InsertAsync(BuildingBelonging entity, Security.Models.UserLogOn userLogOnEntity, IDbTransaction trans = null);
        /// <summary>
        /// 註冊用戶,第三方平臺
        /// </summary>
        /// <param name="entity"></param>
        /// <param name="userLogOnEntity"></param>
        /// <param name="trans"></param>
        bool Insert(BuildingBelonging entity, Security.Models.UserLogOn userLogOnEntity, Security.Models.UserOpenIds userOpenIds, IDbTransaction trans = null);
        /// <summary>
        /// 根據第三方OpenId查詢用戶信息
        /// </summary>
