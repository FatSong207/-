...
namespace Yuebon.Chaochi.IServices
{
    ...
    /// 用戶服務接口
    /// </summary>
    public interface IBuildingService : IService<Building, BuildingOutputDto, string>
    {
        ...
        /// </summary>
        /// <returns></returns>
        Task<List<BuildingPropoties>> GetAllBuildingPropotiesAsync();
        void DoubleUpdate(BuildingEquipment buildingEquipment, BuildingEq buildingEq);
        ...
        bool Insert(Building entity, Yuebon.Security.Models.UserLogOn userLogOnEntity, IDbTransaction trans = null);
        /// <summary>
        /// 註冊用戶
        /// </summary>
        /// <param name="entity"></param>
        /// <param name="userLogOnEntity"></param>
        /// <param name="trans"></param>
        Task<bool> InsertAsync(Building entity, List<BuildingBelonging> buildingBelongingEntitys, IDbTransaction trans = null);
        /// <summary>
        /// 註冊用戶,第三方平臺
        /// </summary>
        /// <param name="entity"></param>
        ...
        /// <param name="trans"></param>
        bool Insert(Building entity, Yuebon.Security.Models.UserLogOn userLogOnEntity, Yuebon.Security.Models.UserOpenIds userOpenIds,IDbTransaction trans = null);
        /// <summary>
        /// 根據第三方OpenId查詢用戶信息
        /// </summary>
        ...
        Task<PageResult<BuildingListOutputDto>> FindWithPagerSearchAsync(SearchBuildingModel search);

        Task<PageResult<MyFileInfo>> FindBuildImagesWithPagerSearchAsync(SearchBuildingModel search);
        ...
        /// <param name="BAdd"></param>
        /// <returns></returns>
        Task<Building> GetBuildingByBAddAsync(string BAdd);
        ...
        /// <returns></returns> 
        Task<bool> UpdateBState(string userId, string Id, string state, IDbConnection conn = null, IDbTransaction trans = null);
        ...
        /// <param name="state">建物狀態</param>
        /// <returns></returns> 
        bool UpdateBStateTask(string userId, string Id, string state, IDbConnection conn = null, IDbTransaction trans = null);
    }
}
