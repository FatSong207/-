...
namespace Yuebon.Chaochi.IServices
{
    ...
    /// 用戶服務接口
    /// </summary>
    public interface IExternalformService : IService<Externalform, ExternalformOutputDto, string>
    {
        /// <summary>
        /// 用戶登陸驗證。
        /// </summary>
        ...
        /// <returns></returns>
        Task<Externalform> GetByFormId(string FormId);
        ...
        bool Insert(Externalform entity, Yuebon.Security.Models.UserLogOn userLogOnEntity, IDbTransaction trans = null);
        /// <summary>
        /// 註冊用戶
        /// </summary>
        /// <param name="entity"></param>
        /// <param name="userLogOnEntity"></param>
        /// <param name="trans"></param>
        Task<bool> InsertAsync(Externalform entity, List<BuildingBelonging> buildingBelongingEntitys, IDbTransaction trans = null);
        /// <summary>
        /// 註冊用戶,第三方平臺
        /// </summary>
        /// <param name="entity"></param>
        ...
        /// <param name="trans"></param>
        bool Insert(Externalform entity, Yuebon.Security.Models.UserLogOn userLogOnEntity, Yuebon.Security.Models.UserOpenIds userOpenIds,IDbTransaction trans = null);
        /// <summary>
        /// 根據第三方OpenId查詢用戶信息
        /// </summary>
        ...
        Task<PageResult<ExternalformOutputDto>> FindWithPagerSearchAsync(SearchExternalformModel search);
