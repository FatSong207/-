...
namespace Yuebon.Chaochi.Repositories
{
    ...
    /// 
    /// </summary>
    public class Building1Repository : BaseRepository<Building1, string>, IBuilding1Repository
    {
        /// <summary>
        /// 
        /// </summary>
        public Building1Repository()
        {
        }

        public Building1Repository(IDbContextCore dbContext) : base(dbContext)
        {
        }
        ...
        /// <returns></returns>
        public async Task<Building1> GetByBAdd(string BAdd)
        {
            string sql = @"SELECT * FROM Chaochi_Building1 t WHERE t.BAdd = @BAdd";
            return await DapperConn.QueryFirstOrDefaultAsync<Building1>(sql, new { BAdd = BAdd });
        }
        ...
        /// <returns></returns>
        public async Task<Building1> GetByBID(string BID)
        {
            string sql = @"SELECT * FROM Chaochi_Building1 t WHERE t.BID = @BID";
            return await DapperConn.QueryFirstOrDefaultAsync<Building1>(sql, new { BID = BID });
        }
        ...
        public  bool Insert(Building1 entity, Security.Models.UserLogOn userLogOnEntity, IDbTransaction trans = null)
        {
            ...
            DbContext.GetDbSet<Building1>().Add(entity);
