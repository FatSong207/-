...
namespace Yuebon.Chaochi.Repositories
{
    ...
    /// 
    /// </summary>
    public class BuildingBelongingRepository : BaseRepository<BuildingBelonging, string>, IBuildingBelongingRepository
    {
        /// <summary>
        /// 
        /// </summary>
        public BuildingBelongingRepository()
        {
        }

        public BuildingBelongingRepository(IDbContextCore dbContext) : base(dbContext)
        {
        }
        ...
        public  bool Insert(BuildingBelonging entity, Security.Models.UserLogOn userLogOnEntity, IDbTransaction trans = null)
        {
            ...
            DbContext.GetDbSet<BuildingBelonging>().Add(entity);
