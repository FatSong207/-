...
namespace Yuebon.Chaochi.Repositories
{
    ...
    /// 
    /// </summary>
    public class B030101Repository : BaseRepository<B030101, string>, IB030101Repository
    {
        /// <summary>
        /// 
        /// </summary>
        public B030101Repository()
        {
        }

        public B030101Repository(IDbContextCore dbContext) : base(dbContext)
        {
        }
        ...
        /// <returns></returns>
        public async Task<B030101> GetByBID(string BID)
        {
            string sql = @"SELECT * FROM Chaochi_B030101 t WHERE t.BID = @BID";
            return await DapperConn.QueryFirstOrDefaultAsync<B030101>(sql, new { BID = BID });
        }
