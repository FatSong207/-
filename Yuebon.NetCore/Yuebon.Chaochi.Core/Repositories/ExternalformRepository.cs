...
namespace Yuebon.Chaochi.Repositories
{
    ...
    /// 
    /// </summary>
    public class ExternalformRepository : BaseRepository<Externalform, string>, IExternalformRepository
    {
        /// <summary>
        /// 
        /// </summary>
        public ExternalformRepository()
        {
        }

        public ExternalformRepository(IDbContextCore dbContext) : base(dbContext)
        {
        }
        ...
        {
            string sql = @"SELECT * FROM Chaochi_Externalform t WHERE t.FormId = @FormId";
            return await DapperConn.QueryFirstOrDefaultAsync<Externalform>(sql, new { FormId = FormId });
        }
        ...
        public  bool Insert(Externalform entity, Security.Models.UserLogOn userLogOnEntity, IDbTransaction trans = null)
        {
            ...
            DbContext.GetDbSet<Externalform>().Add(entity);
        ...
        public async Task<bool> InsertAsync(Externalform entity, List<BuildingBelonging> buildingBelongingEntitys, IDbTransaction trans = null)
        {
            ...
            DbContext.GetDbSet<Externalform>().Add(entity);
            //DbContext.GetDbSet<Security.Models.UserLogOn>().Add(userLogOnEntity);
            DbContext.GetDbSet<BuildingBelonging>().AddRange(buildingBelongingEntitys);
            try
            {
