...
namespace Yuebon.Chaochi.Services
{
    ...
    /// 
    /// </summary>
    public class B030101Service : BaseService<B030101, CustomerLNOutputDto, string>, IB030101Service
    {
        private readonly IB030101Repository _userRepository;
        ...
        public B030101Service(IB030101Repository repository, Security.IRepositories.IUserLogOnRepository userLogOnRepository, Security.IServices.ILogService logService, Security.IServices.IRoleService roleService, Security.IServices.IOrganizeService organizeService) : base(repository)
        {
        ...
        public  async Task<PageResult<CustomerLNOutputDto>> FindWithPagerSearchAsync(SearchUserModel search)
        {
            ...
            List<B030101> list = await repository.FindWithPagerAsync(where, pagerInfo, search.Sort, order);
