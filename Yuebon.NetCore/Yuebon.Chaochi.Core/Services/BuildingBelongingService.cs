...
namespace Yuebon.Chaochi.Services
{
    ...
    /// 
    /// </summary>
    public class BuildingBelongingService : BaseService<BuildingBelonging, BuildingOutputDto, string>, IBuildingBelongingService
    {
        private readonly IBuildingBelongingRepository _userRepository;
        ...
        public BuildingBelongingService(IBuildingBelongingRepository repository, Security.IRepositories.IUserLogOnRepository userLogOnRepository, Security.IServices.ILogService logService, Security.IServices.IRoleService roleService, Security.IServices.IOrganizeService organizeService) : base(repository)
        {
        ...
        public bool Insert(BuildingBelonging entity, Security.Models.UserLogOn userLogOnEntity, IDbTransaction trans = null)
        {
        ...
        /// <param name="userLogOnEntity"></param>
        /// <param name="trans"></param>
        public async Task<bool> InsertAsync(BuildingBelonging entity, Security.Models.UserLogOn userLogOnEntity, IDbTransaction trans = null)
        {
        ...
        /// <param name="userLogOnEntity"></param>
        /// <param name="trans"></param>
        public bool Insert(BuildingBelonging entity, Security.Models.UserLogOn userLogOnEntity, Security.Models.UserOpenIds userOpenIds, IDbTransaction trans = null)
        {
        ...
        public  async Task<PageResult<BuildingOutputDto>> FindWithPagerSearchAsync(SearchUserModel search)
        {
            ...
            List<BuildingOutputDto> resultList = list.MapTo<BuildingOutputDto>();
            ...
            PageResult<BuildingOutputDto> pageResult = new PageResult<BuildingOutputDto>
            {
