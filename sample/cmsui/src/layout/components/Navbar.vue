      ...
      <el-dropdown class="avatar-container right-menu-item" trigger="click">
        ...
        <el-dropdown-menu slot="dropdown" class="user-dropdown">
          <router-link to="/usercenter/index">
            <el-dropdown-item>
              <i class="el-icon-user" />個人中心
            </el-dropdown-item>
          </router-link>

          <el-dropdown-item @click.native="setting = true">
            <svg-icon icon-class="buju" class="iconbuju" /><span class="bujutitle" style="margin-left:6px;">布局設置</span>
          </el-dropdown-item>
          <a target="_blank" href="http://docs.v.yuebon.com">
            <el-dropdown-item>
              <i class="el-icon-question" />使用手冊</el-dropdown-item>
          </a>
