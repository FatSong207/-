...
namespace Yuebon.WebApi.Areas.Security
{
    ...
    public class SysSettingController : ApiController
    {
        ...
        public async Task<IActionResult> GetSysInfo()
        {
            ...
            {
                Log4NetHelper.Error("獲取系統信息異常", ex);
        ...
        public IActionResult Save(SysSetting info)
        {
            ...
            SysSetting sysSettingFile = XmlConverter.Deserialize<SysSetting>("xmlconfig/sys.config");
            SysSetting sysSetting = Merger.CloneAndMerge<SysSetting>(sysSettingFile, info);
            //sysSetting = info;
            //對關鍵信息加密
