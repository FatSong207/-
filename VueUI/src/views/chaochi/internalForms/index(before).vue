...
export default {
  ...
  methods: {
    ...
    //   this.findFormList()
    // },
    findFormList: function() {
      this.tableloading = true
      this.searchPDF.CurrenetPageIndex = this.pagination.currentPage
      this.searchPDF.PageSize = this.pagination.pagesize
      this.searchPDF.Order = this.sortableData.order
      this.searchPDF.Sort = this.sortableData.sort
      this.searchPDF.FormId = this.searchform.FormId
      this.searchPDF.FormName = this.searchform.FormName
      this.searchPDF.Type = this.searchform.Type
      this.searchPDF.Dept = this.searchform.Dept
      findFormList(this.searchPDF).then(res => {
        this.tableData = res.ResData.Items
        this.pagination.pageTotal = res.ResData.TotalItems
        this.tableloading = false
      })
