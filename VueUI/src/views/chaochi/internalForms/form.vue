    ...
    <el-form :model="form" label-width="90px" size="small">
      ...
      <el-card class="box-card">
        ...
        <div class="text item">
          <el-form-item label="社區名稱">
            <el-input v-model="form.BCommunity" class="w140px"></el-input>
          </el-form-item>
        </div>
        <div class="text item">
          <el-form-item label="權狀坪數" class="inline-item">
            <el-input v-model="form.BpingV" class="w80px"></el-input>
          </el-form-item>
          <el-form-item label="實際坪數" class="inline-item">
            <el-input v-model="form.BpingActualV" class="w80px"></el-input>
          </el-form-item>
          <el-form-item label="坪數" class="inline-item">
            <el-input v-model="form.BpingActual" class="w80px"></el-input>
            <span class="word-m-side">元</span>
          </el-form-item>
        </div>
        <div class="text item">
          <el-form-item label="格局" :inline="true">
            <el-input v-model="form.BRoom" class="w60px"></el-input>
            <span class="word-m-side">房</span>
            <el-input v-model="form.BLD" class="w60px"></el-input>
            <span class="word-m-side">廳</span>
            <el-input v-model="form.BBath" class="w60px"></el-input>
            <span class="word-m-side">衛浴</span>
            <el-input v-model="form.BKitchen" class="w60px"></el-input>
            <span class="word-m-side">廚房</span>
            <el-input v-model="form.BBalcony" class="w60px"></el-input>
        ...
        <div class="text item">
          <el-form-item label="建物現況">
            ...
            <el-radio v-model="Belevator" label="Belevator_Y">有</el-radio>
            <el-radio v-model="Belevator" label="Belevator_N">無</el-radio>
            <span class="word-m-side">管理員</span>
            <el-radio v-model="Bsuper" label="Bsuper_Y">有</el-radio>
            <el-radio v-model="Bsuper" label="Bsuper_N">無</el-radio>
            <span class="word-m-side">單層戶數</span>
            <el-input v-model="form.Bhousehold" class="w60px"></el-input>
            <span class="word-m-side">座向</span>
            <el-input v-model="form.Bddirection" class="w100px"></el-input>
          </el-form-item>
        </div>
        <div class="text item">
          <el-form-item label="車位">
            <span class="word-m-side">第</span>
            <el-input v-model="form.BCarNo" class="w80px"></el-input>
            ...
            <el-checkbox
              ...
              >升降式
              <span class="word-m-side">第</span>
              <el-input v-model="form.BCarFloor" class="w60px"></el-input>
        ...
        <div class="text item">
          <el-form-item label="附屬設備" size="mini">
            <div class="text item">
              <el-checkbox
                :true-label="trueValue"
                :false-label="falseValue"
            ...
            <div class="text item">
              <el-checkbox
                ...
                v-model="form.BZ003"
                >冰箱
                <el-input v-model="form.BZ004" class="w60px"></el-input>
              ...
              <el-checkbox
                ...
                v-model="form.BZ005"
                >電視
                <el-input v-model="form.BZ006" class="w60px"></el-input>
                <span class="word-m-side">台</span>
              </el-checkbox>
              <el-checkbox
                :true-label="trueValue"
                ...
                v-model="form.BZ007"
                >冷氣
                <el-input v-model="form.BZ008" class="w60px"></el-input>
                <span class="word-m-side">台</span>
              </el-checkbox>
              ...
              <el-checkbox
                ...
                v-model="form.BZ017"
                >床組
                <el-input v-model="form.BZ018" class="w60px"></el-input>
                <span class="word-m-side">台</span>
              </el-checkbox>
              <el-checkbox
                :true-label="trueValue"
                ...
                v-model="form.BZ019"
                >衣櫃
                <el-input v-model="form.BZ020" class="w60px"></el-input>
                <span class="word-m-side">台</span>
              </el-checkbox>
              <el-checkbox
                :true-label="trueValue"
                ...
                v-model="form.BZ021"
                >沙發
                <el-input v-model="form.BZ022" class="w60px"></el-input>
                <span class="word-m-side">台</span>
              </el-checkbox>
            </div>
          </el-form-item>
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          ...
          <el-card class="box-card">
            <div class="text item">
              <el-form-item label="月租金" class="inline-item">
                <el-input v-model="form.BTrent" class="w80px"></el-input>
                <span class="word-m-side">元</span>
              </el-form-item>
              <el-form-item label="租押金" class="inline-item">
                <el-input v-model="form.BDeposit" class="w80px"></el-input>
                <span class="word-m-side">元</span>
              </el-form-item>
            </div>
            <div class="text item">
            ...
            <div class="text item">
              <el-form-item label="車位租金" class="inline-item">
                <el-input v-model="form.BParkFee" class="w80px"></el-input>
                <span class="word-m-side">元</span>
              </el-form-item>
              <el-form-item label="車位清潔費" class="inline-item">
                <el-input v-model="form.BParkCFee" class="w80px"></el-input>
                <span class="word-m-side">元</span>
              </el-form-item>
            </div>
            <div class="text item">
              <el-form-item label="大樓管理費" class="inline-item">
                <el-input v-model="form.BMFee" class="w80px"></el-input>
                <span class="word-m-side">元</span>
              </el-form-item>
              <el-form-item label="其他費用" class="inline-item">
                <el-input v-model="form.BZ001" class="w80px"></el-input>
                <span class="word-m-side">元</span>
              </el-form-item>
            </div>
            <div class="text item">
              <el-form-item label="仲介費">
                ...
                <el-input v-model="form.BZ033" class="w80px"></el-input>
                <span class="word-m-side">個月</span>
                <span class="word-m-side">二年</span>
                <el-input v-model="form.BZ034" class="w80px"></el-input>
                <span class="word-m-side">個月</span>
              </el-form-item>
            </div>
          </el-card>
          ...
          <el-card class="box-card">
            <div class="text item">
              <el-form-item label="最短租期">
                <el-input v-model="form.BMiniLeaseP" class="w80px"></el-input>
                <span class="word-m-side">年</span>
              </el-form-item>
            </div>
            <div class="text item">
              <el-form-item label="開伙" class="inline-item">
                <el-radio v-model="BCook" label="BCook_Y">可</el-radio>
                <el-radio v-model="BCook" label="BCook_N">不可</el-radio>
              </el-form-item>
            </div>
            <div class="text item">
              <el-form-item label="寵物" class="inline-item">
                <el-radio v-model="BPet" label="BPet_Y">可</el-radio>
                <el-radio v-model="BPet" label="BPet_N">不可</el-radio>
              </el-form-item>
            </div>
            <div class="text item">
              <el-form-item label="神明桌" class="inline-item">
                <el-radio v-model="BGodT" label="BGodT_Y">可</el-radio>
                <el-radio v-model="BGodT" label="BGodT_N">不可</el-radio>
              </el-form-item>
            </div>
            <div class="text item">
              <el-form-item label="鑰匙">
                <el-select v-model="form.keyOptions" placeholder="請選擇">
                  <el-option
                ...
                <el-input v-model="form.BkeyCount" class="w80px"></el-input>
                <span class="word-m-side">隻</span>
              </el-form-item>
            </div>
            <div class="text item">
              <el-form-item label="代收定金" class="inline-item">
                <el-radio v-model="BZ02526" label="BZ025">同意</el-radio>
                <el-radio v-model="BZ02526" label="BZ026">不同意</el-radio>
              </el-form-item>
              <el-form-item label="定金轉為" class="inline-item">
                <el-checkbox
                  :true-label="trueValue"
                  :false-label="falseValue"
                  v-model="form.BZ027"
              ...
              <el-form-item label="超過部分" class="inline-item">
                <el-checkbox
                  :true-label="trueValue"
                  :false-label="falseValue"
                  v-model="form.BZ029"
            ...
            <div class="text item">
              <el-form-item label="代為簽約">
                <el-radio v-model="BZ03132" label="BZ031">同意</el-radio>
                <el-radio v-model="BZ03132" label="BZ032">不同意</el-radio>
              </el-form-item>
            </div>
          </el-card>
        </el-col>
      ...
      <el-card class="box-card">
        <div class="text item">
          <el-form-item label="姓名">
            <el-input v-model="form.LSName" class="w100px"></el-input>
          </el-form-item>
        </div>
        <div class="text item">
          <el-form-item label="身分證字號/統一編號">
            <el-input v-model="form.LSID" class="w140px"></el-input>
          </el-form-item>
        </div>
        <div class="text item">
          <el-form-item label="電話">
            <el-input v-model="form.LSTel_1" class="w60px"></el-input>
            <span class="word-m-side">-</span>
            <el-input v-model="form.LSTel_2" class="w140px"></el-input>
          </el-form-item>
        </div>
        <div class="text item">
          <Address
      ...
      <div style="margin-top: 20px; text-align: center">
        ...
        <el-button type="primary" @click="upload()">存檔</el-button>
      </div>
    </el-form>
  </div>
</template>
