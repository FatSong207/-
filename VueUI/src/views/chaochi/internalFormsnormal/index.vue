        ...
        >
          <template slot-scope="scope">
            ...
            >
              <el-button
                type="primary"
                v-if="scope.row.FormId === 'A000001' || scope.row.FormId === 'A000002'"
                icon="el-icon-download"
                size="mini"
                @click="Jump(scope.row.FormId,scope.row.FormName)"
              />
            </el-tooltip> -->
            <el-tooltip
              effect="dark"
...
export default {
  name: 'Internalformnormal', // 需與菜單的功能編碼一致
  ...
  methods: {
    ...
    // 修改相關功能移至線上表單管理頁(internalformmt)
    ...
    bindEditInfo: function() {
      getInternalformDetail(this.currentId).then(res => {
