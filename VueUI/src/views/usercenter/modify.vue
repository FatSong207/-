    ...
    return {
      ...
      rules: {
        OldPassword: [
          ...
          // { min: 6, max: 50, message: '長度在 6 到 32 個字符', trigger: 'blur' }
        ],
        NewPassword: [
        ...
        NewPassword2: [
          { required: true, message: '請再輸入一次新密碼', trigger: 'blur' }
          // { min: 6, max: 50, message: '長度在 6 到 32 個字符', trigger: 'blur' }
        ]
      },
