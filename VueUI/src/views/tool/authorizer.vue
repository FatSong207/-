  ...
  <div class="app-container">
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column prop="CompanyName" label="公司名稱" sortable="custom" width="300" fixed />
        <el-table-column
          prop="LinkMan"
          label="聯絡人"
          sortable="custom"
    ...
    >
      <el-form ref="editFrom" :inline="true" :model="editFrom" :rules="rules" class="demo-form-inline">
        <el-form-item label="公司名稱" :label-width="formLabelWidth" prop="CompanyName">
          <el-input v-model="editFrom.CompanyName" style="width:500px" placeholder="請輸入公司名稱" autocomplete="off" clearable />
        </el-form-item>
        <el-form-item label="聯絡人" :label-width="formLabelWidth" prop="LinkMan">
          <el-input v-model="editFrom.LinkMan" placeholder="請輸入聯系人" readonly autocomplete="off" clearable />
        </el-form-item>
        <el-form-item label="聯絡電話" :label-width="formLabelWidth" prop="TelPhone">
          <el-input v-model="editFrom.TelPhone" placeholder="請輸入聯系電話" readonly autocomplete="off" clearable />
        </el-form-item>
        <el-form-item label="軟體名稱" :label-width="formLabelWidth" prop="SoftName">
          <el-input v-model="editFrom.SoftName" placeholder="請輸入軟件名稱" autocomplete="off" clearable />
        </el-form-item>
        <el-form-item label="版本號" :label-width="formLabelWidth" prop="Version">
          <el-input v-model="editFrom.Version" placeholder="請輸入版本號" autocomplete="off" clearable />
        </el-form-item>
        ...
        <el-form-item label="特征碼" :label-width="formLabelWidth" prop="MachineCode">
          <el-input v-model="editFrom.MachineCode" style="width:500px" placeholder="請輸入特征碼或機器碼" autocomplete="off" clearable />
        </el-form-item>
        <el-form-item label="公鑰" :label-width="formLabelWidth" prop="PublicKey">
          <el-input v-model="editFrom.PublicKey" style="width:500px" type="textarea" autocomplete="off" clearable />
        </el-form-item>
        <el-form-item label="私鑰" :label-width="formLabelWidth" prop="PrivateKey">
          <el-input v-model="editFrom.PrivateKey" style="width:500px" type="textarea" autocomplete="off" clearable />
        </el-form-item>
        <el-form-item label="註冊碼" :label-width="formLabelWidth" prop="RegistryCode">
          <el-input v-model="editFrom.RegistryCode" type="textarea" style="width:500px" placeholder="請輸入生成註冊碼" autocomplete="off" clearable />
        </el-form-item>
        ...
        <el-form-item label="狀態" :label-width="formLabelWidth" prop="">
