<template>
  <div class="app-container">
            ...
            <div class="grid-content bg-purple">
              <div class="list-btn-container">
                <el-form ref="searchmenuform" :inline="true" :model="searchform" class="demo-form-inline" size="small">
                  <el-form-item>
                    <el-button-group>
                      <el-button type="default" icon="el-icon-refresh" size="mini" @click="loadTableData()">更新</el-button>
                      ...
                      <el-button v-hasPermi="['Menu/Enable']" type="success" icon="el-icon-video-play" size="mini" @click="setMenuEnable('1')">啟用</el-button>
                      <el-button v-hasPermi="['Menu/Delete']" type="danger" icon="el-icon-delete" size="mini" @click="deleteMenuPhysics()">刪除</el-button>
                    </el-button-group>
                  </el-form-item>
                  <el-form-item label="系統名稱：">
                    <el-select v-model="searchmenuform.systemTypeId" style="width:150px" clearable placeholder="請選擇">
                      <el-option
                  ...
                  <el-form-item>
                    <el-button type="primary" size="mini" @click="handleSearch()">查詢</el-button>
                  </el-form-item>
                </el-form>
              </div>
              <el-table
              ...
              >
                ...
                >
                  <template slot-scope="scope">
                    <slot v-if="scope.row.MenuType==='C'" disable-transitions>模組/目錄</slot>
                    <slot v-if="scope.row.MenuType==='M'" disable-transitions>菜單</slot>
                    <slot v-if="scope.row.MenuType==='F'" disable-transitions>功能/按鈕</slot>
                  </template>
                </el-table-column>
                <el-table-column
                  prop="SortCode"
                ...
                >
                  <template slot-scope="scope">
                    <el-tag
                      ...
                      disable-transitions
                    >{{ scope.row.IsShow===true?'顯示':'隱藏' }}</el-tag>
                  </template>
                </el-table-column>
                <el-table-column
                  label="狀態"
    ...
    <!-- 添加或修改菜單對話框 -->
    <el-dialog ref="dialogEditMenuForm" v-el-drag-dialog :title="editMenuFormTitle" append-to-body :visible.sync="dialogMenuEditFormVisible" width="40%">
      <el-form ref="editMenuFrom" :model="editMenuFrom" :rules="rules">
        <el-row>
          <el-col :span="12">
            <el-form-item label="所屬系統" :label-width="formLabelWidth" prop="SystemTypeId">
              <el-select
          ...
          <el-col :span="12">
            <el-form-item label="模組" :label-width="formLabelWidth" prop="ParentId">
              <el-cascader
                :key="cascaderKey"
          ...
          <el-col :span="24">
            <el-form-item label="所屬類型" :label-width="formLabelWidth" prop="MenuType">
              <el-radio-group v-model="editMenuFrom.MenuType" @change="menuTypeChange">
                <el-radio label="C">模組/目錄</el-radio>
                <el-radio label="M">菜單</el-radio>
                <el-radio label="F">功能/按鈕</el-radio>
              </el-radio-group>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item :label="formShowTitle+'名稱'" :label-width="formLabelWidth" prop="FullName">
              <el-input v-model="editMenuFrom.FullName" :placeholder="'請輸入'+formShowTitle+'名稱'" autocomplete="off" clearable />
            </el-form-item>
          </el-col>

          <el-col :span="12">
            <el-form-item :label="formShowTitle+'編碼'" :label-width="formLabelWidth" prop="EnCode">
              <el-input v-model="editMenuFrom.EnCode" :placeholder="'請輸入'+formShowTitle+'編碼'" autocomplete="off" clearable />
            </el-form-item>
          </el-col>

          <el-col v-if="editMenuFrom.MenuType != 'F'" :span="12">
            <el-form-item label="是否外鏈" :label-width="formLabelWidth" prop="IsFrame">
          ...
          <el-col v-if="editMenuFrom.MenuType != 'F'" :span="12">
            <el-form-item label="路徑" :label-width="formLabelWidth" prop="UrlAddress">
              <el-input v-model="editMenuFrom.UrlAddress" placeholder="請輸入路徑" autocomplete="off" clearable />
            </el-form-item>
          </el-col>

          <el-col v-if="editMenuFrom.MenuType == 'M'" :span="12">
            <el-form-item label="組件路徑" :label-width="formLabelWidth" prop="Component">
              <el-input v-model="editMenuFrom.Component" placeholder="請輸入組件路徑" autocomplete="off" clearable />
            </el-form-item>
          </el-col>

          <el-col v-if="editMenuFrom.MenuType == 'M' && !editMenuFrom.IsShow" :span="12">
            <el-form-item label="選中菜單" :label-width="formLabelWidth" prop="ActiveMenu">
              <el-input v-model="editMenuFrom.ActiveMenu" placeholder="請輸入選中菜單路由地址" autocomplete="off" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="圖標" :label-width="formLabelWidth" prop="Icon">
              <el-popover
              ...
              >
                ...
                <el-input slot="reference" v-model="editMenuFrom.Icon" placeholder="點擊選擇圖標" readonly>
                  <svg-icon
          ...
          <el-col :span="12">
            <el-form-item label="排序" :label-width="formLabelWidth" prop="SortCode">
              <el-input v-model.number="editMenuFrom.SortCode" placeholder="請輸入排序,默認為99" autocomplete="off" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="是否顯示" :label-width="formLabelWidth" prop="IsShow">
          ...
          <el-col :span="12">
            <el-form-item label="狀態" :label-width="formLabelWidth" prop="EnabledMark">
          ...
          <el-col v-if="editMenuFrom.MenuType == 'F'" :span="12">
            <el-form-item label="是否緩存" :label-width="formLabelWidth" prop="IsCache">
          ...
          <el-col v-if="editMenuFrom.MenuType == 'F' && currentMenuId===''" :span="12">
            <el-form-item label="批量新增" :label-width="formLabelWidth" prop="IsBatch">
              ...
              <el-link disabled>批量添加菜單下的功能按鈕</el-link>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="saveEditMenuForm()">確 認</el-button>
      </div>
    </el-dialog>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        FullName: [
          { required: true, message: '請輸入模組名稱', trigger: 'blur' },
          { min: 2, max: 50, message: '長度在 2 到 50 個字符', trigger: 'blur' }
        ],
        EnCode: [
          { required: true, message: '請輸入模組編碼', trigger: 'blur' },
          { min: 2, max: 50, message: '長度在 2 到 50 個字符', trigger: 'blur' }
        ],
        SystemTypeId: [
          { required: true, message: '請選擇所屬系統', trigger: 'blur' }
        ],
        UrlAddress: [
          { required: true, message: '請選填寫路由', trigger: 'blur' }
        ]
      },
      formLabelWidth: '80px',
      currentMenuId: '',
